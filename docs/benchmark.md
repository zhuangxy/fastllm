...
``` sh
./benchmark -p ~/chatglm2-6b-int4.flm -f ../example/benchmark/prompts/beijing.txt -b 1
./benchmark -p ~/chatglm2-6b-int8.flm -f ../example/benchmark/prompts/beijing.txt -b 1
./benchmark -p ~/chatglm2-6b-fp16.flm -f ../example/benchmark/prompts/hello.txt -b 512 -l 18
```
